...
# Start up the new ones
exec avconv -i http://$IP/img/video.asf -b 1024k -s 640x480 -re -acodec libmp3lame -ar 11025 -ab 32k -async 3200 -r 15 -f flv q2014rcd/$BASE`date +%y%m%d%H%M`.flv 2>>log/$BASE.slog &
